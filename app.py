...
<section id="about" class="section">
  <div class="section-inner">
    ...
    <div class="about-body">
      <p>I am <strong>Sahil Chawla</strong> a Data Scientist and Technology Consultant at Ernst and Young, based in Gurugram, India. I specialise in Machine Learning, Supply Chain Analytics, and Generative AI.</p>
      ...
      <p>I have delivered ML pipelines at The Schwan Company, a SQL optimisation engine at Ferrero Rocher, Power BI dashboards at Honda, and internal Gen AI tools at EY. Earlier, I built and taught data science curricula across 15 concurrent batches at Great Learning including programs for NUS Singapore.</p>
      <p>Outside work: video games, strong coffee, and going too deep into Figma prototypes.</p>
    </div>
  </div>
</section>
''', unsafe_allow_html=True)
...
experiences = [
    {
        ...
        'highlights': [
            ('PepsiCo', 'Acted as Data Product Manager and SME; owned end-to-end GDO/DFS documentation and delivery across build to hypercare.'),
            ('Schwans Company', 'MLOps engineer; deployed ML inventory-planning pipelines, improving supply chain accuracy by 18%.'),
            ...
            ('EY Internal', 'Built LangChain + Streamlit synthetic data generator and ERNY 2.0 AI chatbot with React UI.'),
        ],
    },
    {
        ...
        'highlights': [
            ('NUS and GLCA Courses', 'Designed and delivered programs generating 50 Cr in revenue.'),
            ('AI Code Tutor', 'Built contextual hint engine leading to 40% user satisfaction uplift and 30% platform engagement increase.'),
    ...
    },
    {
        ...
        'highlights': [
            ...
            ('Computer Vision Projects', 'Led Azure Custom Vision projects including helmet detection and obstacle detection.'),
        ],
    },
]
...
for exp in experiences:
    tags_html = ''.join('<span class="tag">' + t + '</span>' for t in exp['tags'])
    highlights_html = ''.join(
        '<div class="highlight-row"><span class="highlight-client">' + h[0] + '</span><span class="highlight-desc">' + h[1] + '</span></div>'
...
<section id="experience" class="section section-alt">
  <div class="section-inner">
    <div class="section-header">
      ...
      <h2 class="section-title">Where I have shipped<br>real things.</h2>
    </div>
...
projects = [
    ...
    },
    {
        ...
        'approach': 'Applied SMOTE resampling plus Decision Tree and Random Forest; optimised for F1 to handle imbalance.',
    ...
    },
    {
        ...
        'status': 'Shipped',
        'challenge': 'Predict the winning team mid-round from in-game state variables.',
...
proj_cards = ''
for p in projects:
    tags_html = ''.join('<span class="tag">' + t + '</span>' for t in p['tags'])
    proj_cards += '''
<div class="proj-card">
...
skill_groups = [
    ('Languages and Querying', ['Python', 'SQL', 'PL/SQL', 'PySpark']),
    ('ML and AI', ['Machine Learning', 'Deep Learning', 'NLP', 'LLMs', 'LangChain', 'Generative AI', 'Statistics']),
    ('Data and Analytics', ['Data Analysis', 'Data Engineering', 'Tableau', 'Power BI', 'Excel']),
    ('Cloud and Infra', ['Microsoft Azure', 'Databricks', 'Snowflake']),
    ('Frameworks and Tools', ['Streamlit', 'Scikit-learn', 'XGBoost', 'LightGBM', 'CatBoost', 'Pandas', 'NumPy']),
]

skill_html = ''
for group_name, skills in skill_groups:
    pills = ''.join('<span class="skill-pill">' + s + '</span>' for s in skills)
    skill_html += '''
...
education = [
    ('Executive PGP in Management (Data Science and Analytics)', 'Great Lakes Institute of Management, Gurugram', 'Feb 2022 - Feb 2023'),
    ('Post Graduate Program in Data Science and Engineering', 'Great Lakes Institute of Management, Gurugram', 'Oct 2020 - Aug 2021'),
...
<section id="contact" class="section section-alt">
  <div class="section-inner contact-inner">
    <div class="section-header">
      ...
      <h2 class="section-title">Let us build<br>something real.</h2>
            ...
            if not name or not email or not message:
                ...
                try:
                    ...
                    if response.status_code == 200:
                        st.success('Message sent! I will get back to you soon.')
                    else:
...
<footer class="site-footer">
  <div class="footer-inner">
    ...
    <p class="footer-copy">''' + str(datetime.now().year) + ''' Sahil Chawla. All rights reserved.</p>
  </div>
</footer>
''', unsafe_allow_html=True)
