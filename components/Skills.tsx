...
export default function Skills() {
  ...
  return (
    <section ref={sectionRef} id="skills" className="section overflow-hidden">
      ...
      {/* Marquee strip */}
      <div className="border-y border-white/5 py-5 mb-16 reveal">
      ...
      <div className="container">
        <div
          ref={barsRef}
          className="grid md:grid-cols-2 gap-x-16 gap-y-5"
        >
          {skills.map((s) => (
            <div key={s.name} className="reveal">
              <div className="flex justify-between mb-2">
                <span className="font-mono text-xs text-white/60 tracking-wide">{s.name}</span>
